...
class TestContact(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_contact = Contact("James","Muriuki","0742363001","james@ms.com") #create contact object
    ...
    def test_save_contact(self):
        '''
        test_save_contact test case to test if the contact object is saved to the contact list
        '''
...
# setup and class creation up here
    ...
    def test_save_multiple_contact(self):
        '''
        test_save_multiple_contact to check if we can save multiple contacts
        object to our contact_list
        '''
    ...
    def test_delete_contact(self):
        '''
        to test if we can remove contact from contact list.
        '''
        self.new_contact.save_contact()
        test_contact = Contact("Test", "user", "0712345678", "test@user.com") #ne contact
        test_contact.save_contact()
